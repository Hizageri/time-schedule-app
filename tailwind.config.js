  ...
  theme: {
    extend: {
      colors: {
        ...
        /* Full accent color palette for Tailwind classes */
        accent: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
